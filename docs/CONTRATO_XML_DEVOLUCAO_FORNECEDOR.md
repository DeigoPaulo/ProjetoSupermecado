...
- [ ] Completar o contrato neutro e seu validador somente leitura; envelope, referência chave+nItem, identificação, partes, produtos, valores, ajustes, transporte e diagnóstico de totais estão estruturados, mas total fiscal serializável, pagamento, observações e grupos tributários especiais ainda não.
