...
def env_json_array(name, default="[]"):
    raw = os.getenv(name, default)
    try:
        value = json.loads(raw)
    except json.JSONDecodeError as exc:
        raise ImproperlyConfigured(f"{name} deve conter uma lista JSON valida.") from exc
    if not isinstance(value, list):
        raise ImproperlyConfigured(f"{name} deve conter uma lista JSON.")
    return value
...
LOCAL_SERVER_VERSION = os.getenv("LOCAL_SERVER_VERSION", "0.1.13")
FISCAL_QUALIFICATION_MANIFEST_PATH = env_path(
    "FISCAL_QUALIFICATION_MANIFEST_PATH",
    BASE_DIR / "fiscal_channel_qualification_manifest.json",
)
FISCAL_INSTALLATION_IDENTITY_PATH = env_path(
    "FISCAL_INSTALLATION_IDENTITY_PATH",
    BASE_DIR / "server_installation_identity.json",
)
...
LOCAL_BACKUP_MAX_AGE_HOURS = max(0, int(os.getenv("LOCAL_BACKUP_MAX_AGE_HOURS", "0")))
FISCAL_CERTIFICATE_KEY = os.getenv("FISCAL_CERTIFICATE_KEY", SECRET_KEY)
FISCAL_SEFAZ_ADAPTER = os.getenv("FISCAL_SEFAZ_ADAPTER", "")

FOCUS_NFE_FISCAL_TOKEN = os.getenv("FOCUS_NFE_FISCAL_TOKEN", "")
FOCUS_NFE_FISCAL_TOKENS = env_json_object("FOCUS_NFE_FISCAL_TOKENS_JSON")
FOCUS_NFE_FISCAL_BASE_URL = os.getenv(
    "FOCUS_NFE_FISCAL_BASE_URL", "https://homologacao.focusnfe.com.br"
)
FOCUS_NFE_FISCAL_TIMEOUT_SECONDS = int(
    os.getenv("FOCUS_NFE_FISCAL_TIMEOUT_SECONDS", "30")
)
FOCUS_NFE_FISCAL_ALLOW_PRODUCTION = env_bool(
    "FOCUS_NFE_FISCAL_ALLOW_PRODUCTION", False
)
# Integracao SOAP direta com a SEFAZ. Permanece dormente ate ser selecionada
# explicitamente e ter a rede liberada em ambiente controlado.
SEFAZ_DIRETA_NETWORK_ENABLED = env_bool("SEFAZ_DIRETA_NETWORK_ENABLED", False)
SEFAZ_DIRETA_ALLOW_PRODUCTION = env_bool("SEFAZ_DIRETA_ALLOW_PRODUCTION", False)
# Contingencia NF-e modelo 55 pela SVC permanece separada e desligada ate
# haver decisao operacional do Master e homologacao formal com certificado A1.
SEFAZ_DIRETA_SVC_ENABLED = env_bool("SEFAZ_DIRETA_SVC_ENABLED", False)
SEFAZ_DIRETA_TIMEOUT_SECONDS = int(
    os.getenv("SEFAZ_DIRETA_TIMEOUT_SECONDS", "30")
)
SEFAZ_DIRETA_MAX_ATTEMPTS = int(os.getenv("SEFAZ_DIRETA_MAX_ATTEMPTS", "2"))
SEFAZ_DIRETA_RETRY_BASE_MS = int(os.getenv("SEFAZ_DIRETA_RETRY_BASE_MS", "200"))
SEFAZ_DIRETA_CIRCUIT_FAILURE_THRESHOLD = int(
    os.getenv("SEFAZ_DIRETA_CIRCUIT_FAILURE_THRESHOLD", "3")
)
SEFAZ_DIRETA_CIRCUIT_RESET_SECONDS = int(
    os.getenv("SEFAZ_DIRETA_CIRCUIT_RESET_SECONDS", "60")
)
SEFAZ_DIRETA_ENDPOINTS = env_json_object("SEFAZ_DIRETA_ENDPOINTS_JSON")
SEFAZ_DIRETA_DFE_NETWORK_ENABLED = env_bool("SEFAZ_DIRETA_DFE_NETWORK_ENABLED", False)
SEFAZ_DIRETA_DFE_ALLOW_PRODUCTION = env_bool("SEFAZ_DIRETA_DFE_ALLOW_PRODUCTION", False)
SEFAZ_DIRETA_DFE_TIMEOUT_SECONDS = int(os.getenv("SEFAZ_DIRETA_DFE_TIMEOUT_SECONDS", "30"))
SEFAZ_DIRETA_DFE_MAX_XML_BYTES = int(os.getenv("SEFAZ_DIRETA_DFE_MAX_XML_BYTES", str(5 * 1024 * 1024)))
SEFAZ_DIRETA_DFE_ENDPOINTS = env_json_object("SEFAZ_DIRETA_DFE_ENDPOINTS_JSON")
SEFAZ_DIRETA_MANIFESTACAO_NETWORK_ENABLED = env_bool(
    "SEFAZ_DIRETA_MANIFESTACAO_NETWORK_ENABLED", False
)
SEFAZ_DIRETA_MANIFESTACAO_ALLOW_PRODUCTION = env_bool(
    "SEFAZ_DIRETA_MANIFESTACAO_ALLOW_PRODUCTION", False
)
SEFAZ_DIRETA_MANIFESTACAO_ENDPOINTS = env_json_object(
    "SEFAZ_DIRETA_MANIFESTACAO_ENDPOINTS_JSON"
)
SEFAZ_DIRETA_CCE_NETWORK_ENABLED = env_bool(
    "SEFAZ_DIRETA_CCE_NETWORK_ENABLED", False
)
SEFAZ_DIRETA_CCE_ALLOW_PRODUCTION = env_bool(
    "SEFAZ_DIRETA_CCE_ALLOW_PRODUCTION", False
)
FISCAL_UPDATE_MONITOR_ENABLED = env_bool("FISCAL_UPDATE_MONITOR_ENABLED", False)
FISCAL_UPDATE_MONITOR_TIMEOUT_SECONDS = int(
    os.getenv("FISCAL_UPDATE_MONITOR_TIMEOUT_SECONDS", "20")
)
FISCAL_UPDATE_MONITOR_SOURCES = env_json_array(
    "FISCAL_UPDATE_MONITOR_SOURCES_JSON", "[]"
)

FISCAL_DFE_ADAPTER = os.getenv("FISCAL_DFE_ADAPTER", "")
FISCAL_MANIFESTACAO_ADAPTER = os.getenv("FISCAL_MANIFESTACAO_ADAPTER", "")
FISCAL_CCE_ADAPTER = os.getenv("FISCAL_CCE_ADAPTER", "")
FISCAL_CONSULTA_CADASTRO_ADAPTER = os.getenv("FISCAL_CONSULTA_CADASTRO_ADAPTER", "")
SEFAZ_DIRETA_CADASTRO_NETWORK_ENABLED = env_bool("SEFAZ_DIRETA_CADASTRO_NETWORK_ENABLED", False)
SEFAZ_DIRETA_CADASTRO_ALLOW_PRODUCTION = env_bool("SEFAZ_DIRETA_CADASTRO_ALLOW_PRODUCTION", False)
FOCUS_NFE_DFE_TOKEN = os.getenv("FOCUS_NFE_DFE_TOKEN", "")
FOCUS_NFE_DFE_TOKENS = env_json_object("FOCUS_NFE_DFE_TOKENS_JSON")
FOCUS_NFE_DFE_BASE_URL = os.getenv(
    "FOCUS_NFE_DFE_BASE_URL", "https://homologacao.focusnfe.com.br"
).rstrip("/")
FOCUS_NFE_DFE_TIMEOUT_SECONDS = int(os.getenv("FOCUS_NFE_DFE_TIMEOUT_SECONDS", "20"))
FOCUS_NFE_DFE_FETCH_XML = env_bool("FOCUS_NFE_DFE_FETCH_XML", True)
FOCUS_NFE_DFE_ALLOW_PRODUCTION = env_bool("FOCUS_NFE_DFE_ALLOW_PRODUCTION", False)
FINANCEIRO_CONTABIL_ADAPTER = os.getenv("FINANCEIRO_CONTABIL_ADAPTER", "")
FINANCEIRO_EXTRATO_ADAPTERS = env_json_object("FINANCEIRO_EXTRATO_ADAPTERS_JSON")
...
FISCAL_CONTINGENCY_NOT_FOUND_CONFIRMATIONS = int(
    os.getenv("FISCAL_CONTINGENCY_NOT_FOUND_CONFIRMATIONS", "2")
)
...
ASAAS_SUPORTA_CNPJ_ALFANUMERICO = env_bool("ASAAS_SUPORTA_CNPJ_ALFANUMERICO", False)
CADASTRO_CNPJ_PROVIDER_URL = os.getenv("CADASTRO_CNPJ_PROVIDER_URL", "")
CADASTRO_CNPJ_PROVIDER_SUPORTA_ALFANUMERICO = env_bool(
