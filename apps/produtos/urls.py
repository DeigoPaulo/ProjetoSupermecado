...
urlpatterns = [
    ...
    path("precos-programados/", views.versoes_preco, name="versoes_preco"),
    path("precos-programados/novo/", views.agendar_preco, name="agendar_preco"),
    path("precos-programados/<int:pk>/cancelar/", views.cancelar_preco_agendado, name="cancelar_preco_agendado"),
