...
CLASSIFICACOES = {
    ...
    ("tributos_itens", "itens[].grupos.pis.variante_candidata"): _r("CONDICIONADO_GRUPO_CONTRIBUICAO", "0-1_GRUPO/1-1_ESCOLHA", (XSD, CONTADOR), contador=True),
    ("tributos_itens", "itens[].grupos.pis.modalidade_calculo_candidata"): _r("CONDICIONADO_VARIANTE_CONTRIBUICAO", "1-1_NA_VARIANTE_COM_CALCULO", (XSD, CONTADOR), contador=True),
    ("tributos_itens", "itens[].grupos.cofins"): _r("CONDICIONADO_ENQUADRAMENTO", "MISTA", (XSD, CONTADOR), contador=True),
    ("tributos_itens", "itens[].grupos.cofins.variante_candidata"): _r("CONDICIONADO_GRUPO_CONTRIBUICAO", "0-1_GRUPO/1-1_ESCOLHA", (XSD, CONTADOR), contador=True),
    ("tributos_itens", "itens[].grupos.cofins.modalidade_calculo_candidata"): _r("CONDICIONADO_VARIANTE_CONTRIBUICAO", "1-1_NA_VARIANTE_COM_CALCULO", (XSD, CONTADOR), contador=True),
