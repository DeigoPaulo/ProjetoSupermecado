...
CENARIOS_TRIBUTARIOS_GO = (
    ...
    },
    {
        ...
        "modelos": ("55",),
        "status": BLOQUEADO,
        "escopo_atual": "Finalidade, documento referenciado e impostos devolvidos incompletos.",
        "proxima_evidencia": "Fluxo proprio, referencia da entrada e testes de totalizacao.",
    },
    {
