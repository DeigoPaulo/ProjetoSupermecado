...
class PreparacaoDevolucaoFornecedorTests(TestCase):
    ...
    def test_extracao_produtos_usa_somente_memoria_aprovada_sem_recalcular(self):
        ...
        self.assertEqual(obrigatoriedade["validacao"]["quantidade_campos"], 38)
        ...
        self.assertEqual(inventario["validacao"]["quantidade_campos_atomicos"], 111)
        self.assertEqual(inventario["validacao"]["quantidade_lacunas_modelagem"], 3)
