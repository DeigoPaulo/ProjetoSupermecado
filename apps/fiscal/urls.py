...
urlpatterns = [
    ...
    path("devolucoes-fornecedor/revisao/<int:pk>/composicao/revisar/", views.revisar_composicao_devolucao, name="revisar_composicao_devolucao"),
    ...
    path("configuracoes/<int:pk>/homologacao-goias/evidencias/registrar/", views.registrar_evidencia_homologacao_canal, name="registrar_evidencia_homologacao_canal"),
    path("configuracoes/<int:pk>/homologacao-goias/evidencias/<int:evidencia_pk>/revisar/", views.revisar_evidencia_homologacao_canal, name="revisar_evidencia_homologacao_canal"),
    ...
    path("beneficios-produtos/novo/", views.parametrizacao_beneficio_form, name="beneficio_produto_novo"),
    path("beneficios-produtos/<int:pk>/editar/", views.parametrizacao_beneficio_form, name="beneficio_produto_editar"),
