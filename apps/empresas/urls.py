...
urlpatterns = [
    ...
    path("consulta-cadastro/diagnostico.json", views.consulta_cadastro_diagnostico, name="consulta_cadastro_diagnostico"),
    path("sincronizacao/", views.sincronizacao, name="sincronizacao"),
    path("sincronizacao/carga-inicial/", views.sincronizacao_carga_inicial, name="sincronizacao_carga_inicial"),
