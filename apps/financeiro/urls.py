...
urlpatterns = [
    ...
    path("conciliacao-extratos/", views.conciliacao_extratos, name="conciliacao_extratos"),
    path("conciliacao-extratos/modelo.csv", views.modelo_extrato_csv, name="modelo_extrato_csv"),
    path("conciliacao-extratos/<int:pk>/", views.item_extrato_detalhe, name="item_extrato_detalhe"),
    path("conciliacao-extratos/<int:pk>/conciliar/", views.conciliar_item_extrato_view, name="conciliar_item_extrato"),
    path("conciliacao-extratos/<int:pk>/conciliar-recebivel/", views.conciliar_item_recebivel_view, name="conciliar_item_recebivel"),
    path("agenda-recebiveis/", views.agenda_recebiveis, name="agenda_recebiveis"),
    path("agenda-recebiveis/exportar.csv", views.agenda_recebiveis_csv, name="agenda_recebiveis_csv"),
    path("agenda-recebiveis/regras/", views.regras_liquidacao, name="regras_liquidacao"),
    path("agenda-recebiveis/regras/nova/", views.regra_liquidacao_form, name="regra_liquidacao_nova"),
    path("agenda-recebiveis/regras/<int:pk>/editar/", views.regra_liquidacao_form, name="regra_liquidacao_editar"),
