...
CHECKLIST_GRUPOS = [
    ...
    },
    {
        ...
        "itens": [
            ...
            ("Devolução fiscal ao fornecedor", "partial", "O fluxo não emissivo confere a entrada e o XML integral, preserva a chave, o nItem e o retrato tributário original, limita itens e quantidades e submete a preparação com SHA-256. Uma fila separada, isolada por empresa e exclusiva de Administrador/Contabilidade, permite devolver para correção ou aprovar somente a preparação com justificativa e histórico imutável; Compras e Financeiro não decidem, e a aprovação não cria documento, numeração, estoque nem chamada Focus/SEFAZ. Próxima etapa interna: modelar parecer tributário versionado para receber natureza, CFOP e tratamento por tributo validados pelo contador, sem valores presumidos. Geração e homologação real continuam separadas."),
