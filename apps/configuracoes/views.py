...
CHECKLIST_GRUPOS = [
    ...
    },
    {
        ...
        "itens": [
            ...
            ("Contrato de adaptador SEFAZ", "partial", "O ERP possui contrato técnico independente de provedor, validação de transmissão, cancelamento, inutilização, consulta, schema e assinatura, além do comando validar_adaptador_sefaz em modo seguro. Falta escolher o provedor, obter credenciais, implementar o driver específico e homologar os retornos reais da SEFAZ."),
...
CHECKLIST_GRUPOS.append(
    {
        ...
        "itens": [
            ...
            ("Integração fiscal real em homologação", "partial", "Escolher provedor fiscal ou adaptador direto, configurar certificado A1, CSC, IE, séries e credenciais somente no ambiente seguro, e emitir NFC-e/NF-e em homologação antes de qualquer produção."),
