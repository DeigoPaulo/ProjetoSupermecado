...
from .models import ConfiguracaoImpressao, HomologacaoServidorLocal, ModeloEtiqueta, ResultadoHomologacaoServidor, TipoDocumentoImpressao
...
CHECKLIST_GRUPOS = [
    ...
    },
    {
        ...
        "itens": [
            ...
            ("Configuração portatil do PDV desktop", "done", "O executavel instalado ignora arquivos de desenvolvimento ao lado do app e usa o perfil local do Windows em %LOCALAPPDATA%\\DeigoPDV. Cada computador ativa seu proprio terminal sem herdar caminho ou configuração de outra maquina."),
