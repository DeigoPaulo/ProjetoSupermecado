...
CHECKLIST_GRUPOS = [
    ...
    },
    {
        ...
        "itens": [
            ...
            ("Devolução fiscal ao fornecedor", "partial", "O fluxo não emissivo confere a entrada e o XML integral, preserva chave, nItem e retrato tributário, limita quantidades e submete a preparação com SHA-256. A fila exclusiva de Administrador/Contabilidade permite corrigir ou aprovar apenas a preparação; Compras e Financeiro não decidem. Sobre uma aprovação, o parecer tributário append-only registra versões idempotentes de natureza, regime, CFOP de saída validado no catálogo oficial e tratamento humano explícito de ICMS, ICMS-ST/FCP, IPI, PIS, COFINS, cBenef e IBS/CBS, preservando catálogo, revisão e XML por hash. Nada disso cria cálculo, documento, numeração, estoque ou chamada Focus/SEFAZ. Próxima etapa: estruturar parâmetros por nItem vinculados ao parecer, ainda sem defaults nem emissão."),
